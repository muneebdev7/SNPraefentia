"""Tests for SNPraefentia processors."""

import unittest
from snpraefentia.processors.depth import extract_depth, normalize_depth
from snpraefentia.processors.amino_acid import extract_aa_change, compute_aa_impact
import pandas as pd
import numpy as np
