"""Tests for the core SNAP functionality."""

import unittest
import pandas as pd
from snap.core import SNPPrioritizer

class TestSNPPrioritizer(unittest.TestCase):
    """Test the SNPPrioritizer class."""
    
    def setUp(self):
        """Set up test data."""
        self.prioritizer = SNPPrioritizer()
    ...
    def test_process_dataframe(self):
        ...
        result = self.prioritizer.process_dataframe(self.test_df, species)
